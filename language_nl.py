        ...
        self.listSentence(
            {
                "data": d,
                "start": lambda lst: lst[0].h.append(
                    {"label": lst[0].s_he + " studeerde op de "}
                ),
                "item_start": lambda lst: (lst[1](), lst[0].h.append({"label": " "})),
                "date_from": lambda lst: (
                    lst[0].h.append({"label": "van "}),
        ...
        self.listSentence(
            {
                "data": d,
                "start": lambda lst: lst[0].h.append(
                    {"label": lst[0].s_he + " trouwde "}
                ),
                "item_start": lambda lst: (lst[1](), lst[0].h.append({"label": " "})),
                "date_from": lambda lst: (lst[1](), lst[0].h.append({"label": " "})),
                "date_to": lambda lst: (
                    lst[0].h.append({"label": "(getrouwd tot "}),
                    lst[1](),
                    self.h["append"]({"label": ") "}),
                ),
                "item_end": lambda lst: {lst[0].h.append({"label": lst[2]})},
        ...
        self.listSentence(
            {
                "data": d,
                "start": lambda lst: lst[0].h.append(
                    {"label": lst[0].h.is_er + " kinderen zijn "}
                ),
            ...
            self.addPlace(
                {
                    ...
                    "before": self.s_he + " werd begraven in ",
                    "after": ". ",
                }
            )
